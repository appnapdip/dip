...
extension UIButton{
    func button(title: String? = nil, titleColor: UIColor = .white, backgroundImage: UIImage? = nil, backgroundColor: UIColor = .white, titleEdgeInsetsLeft: CGFloat = 0, tag: Int = 0, font: UIFont = UIFont.systemFont(ofSize: 15, weight: .regular), alpha: CGFloat = 1.0, cornerRadius:CGFloat = 0,shadow:CGColor = UIColor.blue.cgColor,shadowOpacity:Float = 0,shadowRadius:Float = 0,borderColor:CGColor = UIColor.yellow.cgColor,borderWidth:CGFloat = 0) -> UIButton{
